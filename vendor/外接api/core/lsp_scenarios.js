...
const SC = {
  ...
  malformed_edit: {
    thinking: "Attempting an edit but omitting the required file arguments.",
    toolCalls: [
      {
        id: "c_bad_edit_1",
        name: "edit",
  ...
  after_tool_validation: {
    thinking: "The previous edit call was rejected locally; retry with the full schema.",
    toolCalls: [
      {
        id: "c_fixed_edit_1",
        name: "edit",
        arguments: JSON.stringify({
          file_path: "/home/user/project/Video.uxml",
          old_string: "<old />",
          new_string: "<new />",
        }),
      },
